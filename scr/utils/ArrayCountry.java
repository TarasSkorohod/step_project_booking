...
public class ArrayCountry {
  public static String[] arrCountry = new String[]{"Afghanistan", "Albania", "Algeria", "American-Samoa", "Andorra", "Angola",
    "Anguilla", "Antigua-and-Barbuda", "Argentina", "Armenia", "Aruba", "Australia", "Austria", "Azerbaijan",
    "Bangladesh", "Barbados", "Bahamas", "Bahrain", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan",
    "Bolivia", "Bosnia-and-Herzegovina", "Botswana", "Brazil", "British-Indian-Ocean-Territory",
    "British-Virgin-Islands", "Brunei-Darussalam", "Bulgaria", "Burkina-Faso", "Burma", "Burundi",
    ...
    "Congo-Brazzaville", "Congo-Kinshasa", "Cook-Islands", "Costa-Rica", "Croatia", "Curaeao", "Cyprus",
    "Czech-Republic", "Denmark", "Djibouti", "Dominica", "Dominican-Republic", "East-Timor", "Ecuador",
    "El-Salvador", "Egypt", "Equatorial-Guinea", "Eritrea", "Estonia", "Ethiopia", "Falkland-Islands",
    "Faroe-Islands", "Federated-States-of-Micronesia", "Fiji", "Finland", "France", "French-Guiana",
    "French-Polynesia", "French-Southern-Lands", "Gabon", "Gambia", "Georgia", "Germany", "Ghana", "Gibraltar",
    "Greece", "Greenland", "Grenada", "Guadeloupe", "Guam", "Guatemala", "Guernsey", "Guinea", "Guinea-Bissau",
    "Guyana", "Haiti", "Heard-and-McDonald-Islands", "Honduras", "Hong-Kong", "Hungary", "Iceland", "India",
    "Indonesia", "Iraq", "Ireland", "Isle-of-Man", "Israel", "Italy", "Jamaica", "Japan", "Jersey", "Jordan",
    ...
    "Qatar", "Reunion", "Romania", "Russia", "Rwanda", "Saint-Barthelemy", "Saint-Helena", "Saint-Kitts-and-Nevis",
    "Saint-Lucia", "Saint-Martin", "Saint-Pierre-and-Miquelon", "Saint-Vincent", "Samoa", "San-Marino",
    "Seo-Tome-and-Prencipe", "Saudi-Arabia", "Senegal", "Serbia", "Seychelles", "Sierra-Leone", "Singapore",
    ...
    "Vanuatu", "Vatican-City", "Vietnam", "Venezuela", "Wallis-and-Futuna", "Western-Sahara", "Yemen",
    "Zambia", "Zimbabwe"};
}
